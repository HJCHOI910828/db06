...
<body>
    ...
    ?>
    <form action="qna_edit_ok.php" name="frm1" method="post">
    <table class="table1">
        <tr>
            <td>글쓴이 :
            <input type="text" name="writer" value="<?=$row["writer"]?>" id=""></td>
        </tr>
        <tr>
            <td>제목 :
            <input type="text" name="title" value="<?=$row["title"]?>" id=""></td>
        </tr>
        <tr>
            <td>내용
            <textarea rows="10" cols="75" name="content" id=""></textarea>
