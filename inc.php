...
<div id="div1">
    ...
    <table class="table1">
        ...
        <tr>
            ...
            <tr>
            <td colspan='5' align="center">
            <input type="button" value="벌크 추가" onclick="location.href='bulk.php'"
            style="background-color:lightcoral; width:100px;color:#fff;border:none;height:40px">
            <input type="button" value="자료 추가" onclick="location.href='inc_write.php'" id="btn">
            <input type="button" value="자료 삭제" onclick="bulk_del()" id="btn">
            </td>
            </tr>
            <?
            }
